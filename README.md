...
Собственный календарь в формате страна_год.json (например, by_2023.json) 
или страна_год.xml (например, by_2023.xml) 
можно разместить в директории folder/custom.
